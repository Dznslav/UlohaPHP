...
include 'qnaclass.php';

$db = new mysqli('localhost', 'root', '', 'formular');
$qna = new QnA($db);
...
<main>
    ...
    <section class="container">
        <?php 
                $qnaArray = $qna->readQuestionsAndAnswers(); 
                foreach ($qnaArray as $qa) {
                    echo "<div class='qna-item'>";
                    echo "<h3 class='question'>" . $qa['question'] . "</h3>";
                    echo "<p class='answer'>" . $qa['answer'] . "</p>";
                    echo "</div>";
                }
            ?>
    </section>
